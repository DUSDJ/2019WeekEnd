...
//{
//    public List<ICharacter> WaitingCharacters;
...
//    void Start()
//    {
//        WaitingCharacters = new List<ICharacter>();
...
//        chara.SetStrength(strength);
//        int intelligence = Random.Range(1, 60);
//        chara.SetIntelligence(intelligence);
//        int agility = Random.Range(1, 60);
//        chara.SetAgility(agility);
