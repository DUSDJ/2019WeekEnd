...
{
    void Do(Character hero);

    bool CheckCondition(Character hero);
...
namespace MyEvent
{
    ...
    public class Event : IHasEvent
    {
        ...
        public bool CheckCondition(Character hero)
        {
...
public class EventManager : Singleton<EventManager>, IEventInfo
{
    ...
    {
        Character[] hero = info.GetCharacters();
    ...
    {
        Dictionary<Character, int> events = info.GetEvents();
...
public interface IDungeonInfo
{
    ...
    void AddEvent(Character hero, int eventId);
    Dictionary<Character, int> GetEvents();
}