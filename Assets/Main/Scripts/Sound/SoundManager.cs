...
public class SoundManager : Singleton<SoundManager>, INeedInitialize
{
    [SerializeField] private SoundDB _db;
    public IEnumerator InitializeCoroutine()
    {
        _db.BGMs = Resources.LoadAll<AudioClip>("Sounds/BGM");
        _db.SFXs = Resources.LoadAll<AudioClip>("Sounds/SFX");
    ...
    public AudioClip[] BGMs { get { return _db.BGMs; } }
    public AudioClip[] SFXs { get { return _db.SFXs; } }
